<#
.SYNOPSIS
    Deletes unwanted internal wiki in DevOps that cant be deleted via GUI.
    Requires Azure CLI and Powershell.
    DevOps PAT requires right to delete wiki repo.
#>

Function DeleteDevOpsInternalWiki
{
    Param(
		...
		[Parameter(Mandatory=$true,
        HelpMessage="DevOps PAT Token requires right to delete wiki repo. Example: 7dth7i7e4Apzy4adzcycgpznaw3kd4di3fh42T37hghetxvh77rq")]
        [String]
        $AzureDevOpsPAT
    )
